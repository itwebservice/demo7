!(function (t, i, s, o) {
  ...
  e.prototype = {
    ...
    isSingle: function () {
      return (
        "number" == typeof this.options.value ||
    ...
    onDragStart: function (i) {
      if (
        !(this.options.disable || ("mousedown" === i.type && 1 !== i.which))
      ) {
        i.stopPropagation(), i.preventDefault();
        var o = t(i.target);
        this.pointers.removeClass("last-active"),
          o.addClass("focused last-active"),
          this[(o.hasClass("low") ? "low" : "high") + "Label"].addClass(
            "focused"
          ),
          t(s).on(
            "mousemove.slider touchmove.slider",
            t.proxy(this.onDrag, this, o)
          ),
          t(s).on(
    ...
    barClicked: function (t) {
      if (!this.options.disable) {
        ...
        if (this.isSingle()) this.setPosition(this.pointers.last(), i, !0, !0);
          ...
          var s,
            o = Math.abs(parseFloat(this.pointers.first().css("left"), 10)),
    ...
    setPosition: function (t, i, s, o) {
      var e,
        n = parseFloat(this.lowPointer.css("left")),
      ...
      t[0] === this.highPointer[0]
        ? (a = Math.round(i - h))
        : (n = Math.round(i - h)),
        t[o ? "animate" : "css"]({ left: Math.round(i - h) }),
    ...
    renderScale: function () {
      for (
        var i = this.options.scale || [this.options.from, this.options.to],
          s = Math.round((100 / (i.length - 1)) * 10) / 10,
          o = "",
          e = 0;
        e < i.length;
        e++
    ...
    showPointerValue: function (i, s, o) {
      var e,
        n = t(".pointer-label", this.domNode)[
          i.hasClass("low") ? "first" : "last"
        ](),
    ...
    return (
      this.each(function () {
        var a = t(this),
          ...
          l = "object" == typeof s && s;
        h ||
          (a.data("plugin_jRange", (h = new e(this, l))),
          t(i).resize(function () {
            h.setValue(h.getValue());
          })),
          "string" == typeof s &&
            (o = h[s].apply(h, Array.prototype.slice.call(n, 1)));
      }),
      o || this
    );
  };
