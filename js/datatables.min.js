 ...
 *   https://datatables.net/download/#dt/dt-1.10.20/fc-3.3.0/fh-3.1.6/r-2.2.3/sc-2.0.1/sp-1.0.1

 *

 * Included libraries:

 *   DataTables 1.10.20, FixedColumns 3.3.0, FixedHeader 3.1.6, Responsive 2.2.3, Scroller 2.0.1, SearchPanes 1.0.1
...
(function (f) {
  ...
  function pb(a) {
    ...
    for (b = k.length; l < b; l++) {
      ...
      a.oFeatures.bSort &&
        ...
        !1 !== n.bSortable &&
          (m.attr("tabindex", a.iTabIndex).attr(
            "aria-controls",
  ...
  function tb(a) {
    ...
    l.children().append(
      a.oLanguage.sLengthMenu.replace(
        "_MENU_",
        ...
        b.on("column-visibility.dt.DT_details", function (b, e, f, g) {
          if (a === e)
            for (e = W(e), f = 0, g = c.length; f < g; f++)
              (b = c[f]),
                b._details &&
                  b._details.children("td[colspan]").attr(
                    "colspan",
  ...
  q.ext = C = {
    ...
    classes: {},
    build: "dt/dt-1.10.20/fc-3.3.0/fh-3.1.6/r-2.2.3/sc-2.0.1/sp-1.0.1",
    errMode: "alert",
    feature: [],
    search: [],
...
(function (c) {
  ...
  c.extend(m.prototype, {
    ...
    _clone: function (a, b) {
      ...
      !b && d.floating
        ? d.floating.removeClass("fixedHeader-floating fixedHeader-locked")
        : (d.floating &&
    ...
    _modeChange: function (a, b, e) {
      ...
      h && h.blur();
      "in-place" === a
        ? (d.placeholder && (d.placeholder.remove(), (d.placeholder = null)),
          this._unsize(b),
    ...
    _scroll: function (a) {
      ...
      this.c.footer &&
        ...
        (this.s.enable &&
          (k =
            !d.visible ||
            b + d.windowHeight >= d.tfootBottom + this.c.footerOffset
              ? "in-place"
              : d.windowHeight + b >
...
(function () {
  var b = $.fn.dataTable,
    m = (function () {
      ...
      f.prototype._findUnique = function (
        a,
