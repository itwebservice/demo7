(function ($) {
  $.fn.vialert = function (options) {
    ...
    var cur_item =
      ...
      '" class="item ' +
      settings.type +
      '"><div class="head"><div class="heading">' +
      settings.title +
      '</div><div class="close_btn"></div></div><div class="body"><div class="Content">' +
      settings.message +
      "</div></div></div>";
  ...
  $.fn.vi_confirm_box = function (options) {
    ...
    if (settings.true_btn) {
      btn_text +=
        '<button class="yes_btn" type="button">' +
        settings.true_btn_text +
        "</button>";
    }

    if (settings.false_btn) {
      btn_text +=
        '<button class="no_btn" type="button">' +
        settings.false_btn_text +
        "</button>";
    }
