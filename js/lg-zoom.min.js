...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(e)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).lgZoom =
        e());
})(this, function () {
  "use strict";
  var t = function () {
    ...
    return (
      ...
      (h.prototype.getImageSize = function (t, e, o) {
        return (
          ...
          t[{ y: "offsetHeight", x: "offsetWidth" }[o]]
        );
      }),
      ...
      (h.prototype.getCurrentRotation = function (t) {
        ...
        return e
          ? Math.round(
              Math.atan2(parseFloat(e[1]), parseFloat(e[0])) * (180 / Math.PI)
            )
          : 0;
      }),
      ...
      (h.prototype.zoomImage = function (t) {
        var e,
          ...
          n = Math.abs(a - r) / 2,
          l =
            (this.containerRect.height - this.imageYSize - n * this.modifierX) /
              2 +
            this.scrollTop +
      ...
      (h.prototype.getPossibleSwipeDragCords = function (t, e) {
        ...
        return (
          90 === Math.abs(t) && (m = { minY: c, maxY: h, minX: l, maxX: g }), m
        );
      }),
