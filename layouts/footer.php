          ...
          <div class="col col-12 col-md-6 col-lg-4 col-xl-4">
            <div class="footer-address">
              <a href="#" class="footer-logo">
                <img src="<?php echo $admin_logo_url; ?>" alt="Footer_Logo" class="img-fluid">
              </a>
              ...
              <ul class="footer-social-list">
                <li class="footer-social-item">
                  <a href="<?php echo $social->fb; ?>" class="footer-social-link">
                    <i class="fa-brands fa-facebook-f"></i>
                  </a>
                </li>
                <li class="footer-social-item">
                  <a href="<?php echo $social->tw; ?>" class="footer-social-link">
                    <i class="fa-brands fa-twitter"></i>
                  </a>
                </li>
                <li class="footer-social-item">
                  <a href="<?php echo $social->yu; ?>" class="footer-social-link">
                    <i class="fa-brands fa-youtube"></i>
                  </a>
                </li>
                <li class="footer-social-item">
                  <a href="<?php echo $social->wa; ?>" class="footer-social-link">
                    <i class="fa-brands fa-whatsapp"></i>
                  </a>
                </li>
                <li class="footer-social-item">
                  <a href="<?php echo $social->li; ?>" class="footer-social-link">
                    <i class="fa-brands fa-linkedin"></i>
                  </a>
                </li>
                <li class="footer-social-item">
                  <a href="<?php echo $social->insta; ?>" class="footer-social-link">
