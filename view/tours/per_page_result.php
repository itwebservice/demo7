...
<input type="hidden" id="taxation-<?=$tours_result_array[$i]['package_id']?>"
    value='<?= $tours_result_array[$i]['taxation'][0]['taxation_type'].'-'.$tours_result_array[$i]['taxation'][0]['service_tax']?>'>
<!-- ***** Tours Card ***** -->
<div class="c-cardList type-hotel">
    <div class="c-cardListTable">
        ...
        <div class="cardList-image">
            ...
            <input type="hidden" value="<?= $tours_result_array[$i]['image'] ?>"
                id="image-<?= $tours_result_array[$i]['package_id'] ?>" />
            <div class="typeOverlay">
                <div class="c-discount c-hide" id='discount<?= $tours_result_array[$i]['package_id'] ?>'>
                    <div class="discount-text">
                        <span class="currency-icon"></span>
                        <span class='offer-currency-price'
                            id="offer-currency-price<?= $tours_result_array[$i]['package_id'] ?>"></span>&nbsp;&nbsp;<span
                            id='discount_text<?= $tours_result_array[$i]['package_id'] ?>'></span>
                        <span class='c-hide offer-currency-id'
                            id="offer-currency-id<?= $tours_result_array[$i]['package_id'] ?>"></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardList-info" role="button">
            ...
            <div class="dividerSection type-1 noborder">
                <div class="divider s1" role="button" data-toggle="collapse"
                    href="#collapseExample<?= $tours_result_array[$i]['package_id']?>" aria-expanded="false"
                    aria-controls="collapseExample">
                    <a>
                        <h4 class="cardTitle"><span
                                id="package-<?= $tours_result_array[$i]['package_id'] ?>"><?= $tours_result_array[$i]['package_name']?></span>
                            <span class="c-tag"
                                id="package_code-<?= $tours_result_array[$i]['package_id'] ?>"><?= $tours_result_array[$i]['package_code']?></span>
                        </h4>
                    </a>
                    ...
                    <div class="infoSection">
                        <span class="cardInfoLine cust">
                            ...
                            <input type="hidden"
                                value="<?= $tours_result_array[$i]['total_nights'].'-'.$tours_result_array[$i]['total_days'] ?>"
                                id="days-<?= $tours_result_array[$i]['package_id'] ?>" />
                        </span>
                    </div>
                </div>
              ...
              ?>
                        <div class="p-old">
                            ...
                            <span class="o_price">
                                ...
                                <span
                                    class="p_cost best-tours-orgamount"><?= $tours_result_array[$i]['best_org_cost']['org_cost']?></span>
                        ...
                        <div class="p-old">
                            ...
                            <span class="price_main">
                                <span class="p_currency currency-icon"></span>
                                <span
                                    class="p_cost best-currency-price"><?= $tours_result_array[$i]['best_lowest_cost']['cost']?></span>
        ...
        <div class="cardList-accordian">
            ...
            <div class="c-compTabs">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="itinerary-tab" data-toggle="tab"
                            href="#itinerary-tab<?= $tours_result_array[$i]['package_id']?>" role="tab"
                            aria-controls="itinerary" aria-selected="true">Itinerary</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="travel-tab" data-toggle="tab"
                            href="#travel-tab<?= $tours_result_array[$i]['package_id']?>" role="tab"
                            aria-controls="travel" aria-selected="true">Travel & Stay</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="inclusion-tab" data-toggle="tab"
                            href="#inclusion-tab<?= $tours_result_array[$i]['package_id']?>" role="tab"
                            aria-controls="inclusion" aria-selected="true">INCLUSIONS/EXCLUSIONS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="costing-tab" data-toggle="tab"
                            href="#costing-tab<?= $tours_result_array[$i]['package_id']?>" role="tab"
                ...
                <div class="tab-content" id="myTabContent">
                    <!-- **** Tab costing **** -->
                    <div class="tab-pane fade" id="costing-tab<?= $tours_result_array[$i]['package_id']?>"
                        role="tabpanel" aria-labelledby="costing-tab">
                        <!-- ///////////////////// -->
                        <?php
              $room_cost1 = 0;  
                ...
                ?>
                        ...
                        <div class="c-cardListHolder">
                            <div class="c-cardListTable type-2">
                                ...
                                <input type="hidden" id="coupon-<?=$tours_result_array[$i]['package_id'] ?>"
                                    value='<?php echo json_encode($coupon_list_arr); ?>'>
                                <!-- *** Type Card Info *** -->
                                        ...
                                        <div class="gridItem">
                                            ...
                                            <div class="styleForMobile">
                                                <div class="infoCard c-halfText m0">
                                                    ...
                                                    <span
                                                        class="sect s2"><?= $tours_result_array[$i]['costing_array'][$j]['min_pax'].'-'.$tours_result_array[$i]['costing_array'][$j]['max_pax']?></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="infoCard m0">
                                                <div class="M-infoCard">
                                                    ...
                                                    <div class="infoCard_price strike">
                                                        <span class="p_currency currency-icon"></span>
                                                        <span
                                                            class="p_cost tours-orgcurrency-price"><?= $org_cost ?></span>
                                                        <span
                                                            class="c-hide tours-orgcurrency-id"><?= $h_currency_id ?></span>
                                                    </div>
                                            ...
                                            <div class="infoCard m0">
                                                <div class="M-infoCard">
                                                    ...
                                                    <div class="infoCard_price">
                                                        <span class="p_currency currency-icon"></span>
                                                        <span
                                                            class="p_cost tours-currency-price"><?= $room_cost ?></span>
                                                        <span
                                                            class="c-hide tours-currency-id"><?= $h_currency_id ?></span>
                                                    </div>
                                                    <span class="infoCard_priceTax">(exclusive of all taxes)</span>
                                                </div>
                                            </div>
                    ...
                    <!-- **** Tab itenary **** -->
                    <div class="tab-pane fade show active" id="itinerary-tab<?= $tours_result_array[$i]['package_id']?>"
                        role="tabpanel" aria-labelledby="itinerary-tab">
                    ...
                    <!-- **** Tab Tours Car **** -->
                    <div class="tab-pane fade" id="travel-tab<?= $tours_result_array[$i]['package_id']?>"
                        role="tabpanel" aria-labelledby="travel-tab">
                        <!-- **** Tab Hotel Car **** -->
                                            ...
                                            <div class="cardList-info">
                                                <div class="flexGrid">
                                                    <div class="gridItem">
                                                        <div class="infoCard">
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['hotels_array'][$hotel_i]['hotel']?></span>
                                                            <span
                                                                class="infoCard_data"><?= $tours_result_array[$i]['hotels_array'][$hotel_i]['city']?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="gridItem">
                                                        <div class="infoCard c-halfText m0">
                                                            ...
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['hotels_array'][$hotel_i]['hotel_type']?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="gridItem styleForMobile M-m0">
                                                        <div class="infoCard m5-btm">
                                                            ...
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['hotels_array'][$hotel_i]['nights']?>
                                                                Nights</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flexGrid">
                                                    <div class="gridItem">
                                                        <div class="infoCard">
                                                            ...
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['transport_array'][$tr_i]['vehicle']?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="gridItem">
                                                        <div class="infoCard c-halfText m0">
                                                            ...
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['transport_array'][$tr_i]['pickup']?></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="gridItem styleForMobile M-m0">
                                                        <div class="infoCard m5-btm">
                                                            ...
                                                            <span
                                                                class="infoCard_price"><?= $tours_result_array[$i]['transport_array'][$tr_i]['drop'] ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <!-- **** Tab Tours Car End **** -->
                    <!-- **** Tab Policies **** -->
                    <div class="tab-pane fade" id="inclusion-tab<?= $tours_result_array[$i]['package_id']?>"
                        role="tabpanel" aria-labelledby="inclusion-tab">
                        <!-- **** Policies List **** -->
                    ...
                    <div class="clearfix text-right">
                        <button class="c-button md" id='<?=$tours_result_array[$i]['package_id']?>'
                            onclick='redirect_to_action_page("<?= $tours_result_array[$i]["package_id"]?>","1",<?= json_encode($package_type_arr)?>,<?=$adult_count?>,<?=$child_wocount?>,<?=$child_wicount?>,<?=$extra_bed_count?>,<?=$infant_count?>,"<?=$travel_date?>")'><i
