            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <h3 class="ts-reason-card-title">Quality and Services</h3>

                        <p class="ts-reason-card-description">our quality and service go hand-in-hand to help achieve the core values</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <h3 class="ts-reason-card-title">Valuable Support</h3>

                        <p class="ts-reason-card-description">Open mind and a caring ear in case of any emergency help needed</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <h3 class="ts-reason-card-title">Tailor-made Holidays</h3>

                        <p class="ts-reason-card-description">Designed with you in mind, our packages can be tailored made completely from scratch.</p>
            ...
            <div class="col col-12 col-md-6 col-lg-6">
                ...
                <div class="ts-reason-card">
                    ...
                    <div class="ts-reason-card-body">
                        ...
                        <h3 class="ts-reason-card-title">Save Time and Effort</h3>

                        <p class="ts-reason-card-description">Our experience staff help to save the time. only pay, pack and begin your journey.</p>
